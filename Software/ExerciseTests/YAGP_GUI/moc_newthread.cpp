...
QT_MOC_LITERAL(3, 24, 15) // "AngleChangedOne"

    },
    "newThread\0AngleChanged\0\0AngleChangedOne"
};
...
void newThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->AngleChangedOne((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (newThread::*)(double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&newThread::AngleChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (newThread::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&newThread::AngleChangedOne)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void newThread::AngleChanged(double _t1, double _t2, double _t3)
{
...
// SIGNAL 1
void newThread::AngleChangedOne(double _t1)
{
